...
public class Atencion extends Thread {
    ...
    public boolean obtenerFlujos() {
        try {
            ...
            Log.e("ERROR", "No se pudo obtener los flujos");
        }
        return conectado;
    }
    ...
    public void enviarAlCliente(String mensaje) {
        try {
            ...
            Log.e("ERROR", "No se pudo enviar la informacion al cliente");
        }
    }
    ...
    private void cargarLista () {
        ...
        for (Atencion a : Servidor.clientes) {
            if (a != this && a.visible) {
                cad.append(a.user).append("@");
            }
        }
        if (cad.length() > 0) {
            cad = new StringBuilder(cad.substring(0, cad.length() - 1));
        }
        enviarAlCliente("visibles@"+cad.toString());
    }
    ...
    public void cerrarConexion() {
        try {
            ...
            Log.e("ERROR", "No se pudo cerrar la conexion");
        }
    }
