...
public class GUINuevoAudio_Escoger extends javax.swing.JDialog {

    private final GUIAnalisis guiAnalisis;
    
    public GUINuevoAudio_Escoger(GUIAnalisis parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        JRB_ClienteServidor = new javax.swing.JRadioButton();
        ...
        setTitle("Tipo de Grabacion");

        JP_Fondo.setBackground(new java.awt.Color(255, 255, 255));

        JL_Tipo.setText("Escoga el Tipo de Grabación:");

        JRB_ClienteServidor.setBackground(new java.awt.Color(255, 255, 255));
        JBG_Tipo.add(JRB_ClienteServidor);
        JRB_ClienteServidor.setText("Cliente y Servidor");

        JRB_Cliente.setBackground(new java.awt.Color(255, 255, 255));
        JBG_Tipo.add(JRB_Cliente);
        JRB_Cliente.setText("Cliente");

        JRB_Ninguno.setBackground(new java.awt.Color(255, 255, 255));
        JBG_Tipo.add(JRB_Ninguno);
        ...
        JP_FondoLayout.setHorizontalGroup(
            ...
            .addGroup(JP_FondoLayout.createSequentialGroup()
                ...
                .addGroup(JP_FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(JRB_Ninguno, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(JRB_Cliente, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(JRB_ClienteServidor))
    ...
    private void JB_AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_AceptarActionPerformed
        if (JRB_ClienteServidor.isSelected()) {
            this.dispose();
            guiAnalisis.setVisible(false);
            new GUINuevoAudio(guiAnalisis, true, 1).setVisible(true);
        } else if (JRB_Cliente.isSelected()) {
            this.dispose();
            guiAnalisis.setVisible(false);
            new GUINuevoAudio(guiAnalisis, true, 2).setVisible(true);
        } else if (JRB_Ninguno.isSelected()) {
            this.dispose();
            guiAnalisis.setVisible(false);
            new GUINuevoAudio(guiAnalisis, true, 3).setVisible(true);
        }
    ...
    private javax.swing.JRadioButton JRB_ClienteServidor;
